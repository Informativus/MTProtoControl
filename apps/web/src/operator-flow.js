      ...
      !hasServer
        ...
        : sshTestSuccessful
          ...
          : hasSavedKeyPath
            ...
            : sshAuthReady
              ? 'SSH-доступ готов к проверке подключения.'
              : 'SSH-доступ не настроен.',
      !hasServer
    ...
    createStep(
      ...
      !hasServer
        ...
        : !hasConfig
          ...
          : !sshAuthReady
            ? 'Для диагностики превью деплоя нужен SSH-доступ.'
            : hasDiagnostics
      ...
      !hasServer
        ...
        : !hasConfig
          ...
          : isApplied
            ? ''
          : !sshAuthReady
            ? 'Настройте SSH-доступ перед загрузкой превью деплоя.'
            : hasDiagnostics
              ? ''
